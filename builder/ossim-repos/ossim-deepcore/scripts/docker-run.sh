...
#
####################################################################################################
OSSIM_CONTEXT_IMAGE="ossim-run-context"
...
usage() {
  ...
  echo "               directory on /home/ossim in the container."
...
if [ "$1" == "-x" ] ; then
  # No mounts:
  shift
  docker run --rm -it -w /home/ossim ${OSSIM_CONTEXT_IMAGE}:latest $*
